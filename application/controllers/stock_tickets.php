...
class Stock_tickets extends CI_Controller {
  ...
  public function test_run() {
      ...
      $this->unit->run($this->ticket->find(1), array("ticketNum"=>"1", "pid"=>"1", "uid"=>"2", "PriceUSD"=>"10", "Quantity"=>"2", "DateSubmitted"=>"2011-11-18 00:23:35", "Status"=>"Delivered"), 'Stock Ticket find(1) General Test', 'Test that the find(1) function of the Stock Ticket Model returns the correct object.');
      ...
      $this->unit->run(current($this->ticket->all(1)), array("ticketNum"=>"1", "pid"=>"1", "uid"=>"2", "PriceUSD"=>"10", "Quantity"=>"2", "DateSubmitted"=>"2011-11-18 00:23:35", "Status"=>"Delivered"), 'Stock Ticket all(1) General Test', 'Test that the all(1) function of the Stock Ticket Model returns the correct database row.');
